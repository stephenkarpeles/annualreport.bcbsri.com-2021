      ...
      <div className="container">
        <div className="footer__col-wrap">
          <div className="footer__col footer__col--1">
            <ul>
              <li><a href="http://2019annualreport.bcbsri.com/">2019 Annual Report</a></li>
              <li><a href="http://2019communityreport.bcbsri.com/">2019 Community Report</a></li>
            </ul>
          </div>
          <div className="footer__col footer__col--2">
            <ul>
              <li><a href="https://www.bcbsri.com/privacy-policy">Privacy Statement</a></li>
              <li><a href="https://www.bcbsri.com/how-blue-cross-protecting-your-information">Security &amp; Fraud Protection</a></li>
              <li><a href="https://www.bcbsri.com/terms-conditions">Terms &amp; Conditions</a></li>
            </ul>
          ...
          <div className="footer__col footer__col--3">
            <ul>
              <li><a href="http://twitter.com/BCBSRI"><StaticImage src="../../images/icons/icon-twitter.svg" alt=""/></a></li>
              <li><a href="http://www.facebook.com/BCBSRI"><StaticImage src="../../images/icons/icon-facebook.svg" alt=""/></a></li>
              <li><a href="http://www.linkedin.com/company/blue-cross-&-blue-shield-of-rhode-island"><StaticImage src="../../images/icons/icon-linkedin.svg" alt=""/></a></li>
            </ul>
          </div>
        </div>
      </div>
