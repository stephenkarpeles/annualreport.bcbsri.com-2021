          ...
          <div className="image-number-block__number">
            <Fade>
              <LargeNumber
                ...
                featNumNumber="46"
                featNumValue="%"
                featNumText="of telehealth visits in 2020 were for behavioral health services"
              />
            </Fade>
          </div>
        </div>        
            ...
            <div className="content-block__col-wrap">
              <div className="content-block__col content-block__col--left">
                <SmallNumber 
                  ...
                  smallNumCaption="increase in use of telehealth since 2019"
                />
              </div>
              <div className="content-block__col content-block__col--right">
          ...
          <div className="container container--small">
            ...
            <div className="content-block__col-wrap">
              <div className="content-block__col content-block__col--left">
                ...
                <p>The stores are open, with COVID-19 protocols in place, to answer members' questions. But
                since we stopped offering in-person fitness classes due to the pandemic, we wanted to give our members another way to stay fit and connect with each other. Our solution was to offer fitness classes <a target="_blank" rel="noreferrer" href="https://www.facebook.com/groups/yourbluestorestudio/">live on Facebook</a>. They were so well received that we soon produced a different class every weekday and even introduced live workshops on healthy living. Since these classes are available on Facebook, they can help all Rhode Islanders (and people living anywhere) to be healthier.</p>
                <p>To help our BCBSRI Medicare Advantage members take advantage of their health and wellness benefits during the pandemic, we mailed them information about the Facebook classes and a no-cost fitness kit that included resistance bands, a water bottle, and a towel.</p> 
