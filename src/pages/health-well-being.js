        ...
        <div className="container container--small">
            <Fade>
              <div className="content-block__intro">
                ...
                <h2>Expanding coverage during COVID-19&mdash;at no added cost to members</h2>
              </div>
            </Fade>
          ...
          <Fade>
            <div className="content-block__col-wrap">
              <div className="content-block__col content-block__col--left mar-bot-3">
                ...
                <p>We now have <a target="_blank" rel="noreferrer" href="https://www.bcbsri.com/safezones">41 sites</a> certified to provide safe, affirming, and inclusive care to the LGBTQ community.</p>                
              </div>
              <div className="content-block__col content-block__col--right mar-bot-3"> 
                ...
                <p>The keynote speaker for our employee Diversity Week was <a target="_blank" rel="noreferrer" href="https://www.ibramxkendi.com/">Dr. Ibram X. Kendi</a>, one of America’s foremost historians and leading antiracist voices. He is the author of <em>Stamped from the Beginning</em> and <em>How to be an Antiracist</em>.</p>                 
              </div> 
            </div> 
          </Fade>
